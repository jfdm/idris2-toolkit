...
public export
bin : (shape : BIN type kindA kindB kindC)
   -> (annot : a)
...
public export
tri : (shape : TRI type kindA kindB kindC kindD)
   -> (annot : a)
   -> (inA   : AST type kindB a)
   -> (inB   : AST type kindC a)
